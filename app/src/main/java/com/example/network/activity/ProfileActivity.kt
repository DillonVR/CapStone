...
import com.example.network.databinding.ActivityProfile2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                // get the profile picture or supply given one
                if (user.profileImage ==""){
                    binding.userImage.setImageResource(com.example.network.R.drawable.profilepic)
                }else{
        ...
        if (filePath != null) {
            ...
            ref.putFile(filePath!!)
                .addOnSuccessListener {
                    ...
                    databaseReference.child("profileImage").setValue(filePath.toString())
